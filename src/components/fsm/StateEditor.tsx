      ...
      <FormControlLabel
        control={
          <Checkbox
            ...
            checkedIcon={<PlayCircleOutline className="text-green-500" />}
            onChange={e => onChange({ isStartState: e.target.checked })}
          />
        }
        label="Start"
      />
      <FormControlLabel
        control={
          <Checkbox
            ...
            checkedIcon={<StopCircleOutlined className="text-red-500" />}
            onChange={e => onChange({ isEndState: e.target.checked })}
          />
        }
        label="End"
      />
