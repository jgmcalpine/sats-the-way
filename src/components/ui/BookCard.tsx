...
const BookCard: React.FC<BookCardProps> = ({
  ...
  const displayAuthor = authorName || `${authorPubkey?.slice(0, 5)}...${authorPubkey?.slice(-3)}`;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onMouseEnter={e => (e.currentTarget.style.transform = 'rotateY(3deg) rotateX(2deg)')}
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(to right, #f9f9f9, #eeeeee, #f9f9f9)',
        ...
        <Card
          ...
          sx={{
            boxShadow: '0 10px 20px -5px rgba(0, 0, 0, 0.3), 0 5px 10px -3px rgba(0, 0, 0, 0.1)',
