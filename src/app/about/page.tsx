      ...
      <Box className="flex flex-col w-full">
        <Box className="flex flex-col gap-8">
          ...
          <Typography variant="body1">
            Neither bitcoin or nostr are required to read free content on SatsTheWay. To fully
            experience the application, one can connect a nostr account (to publish a story) and/or
            a lightning wallet (to pay for stories that implement paywalls).
          </Typography>
          <Typography variant="body1">
            As always do your own research. We have used{' '}
            <Link className="text-blue-600" href="https://www.coinos.io">
              coinos.io
            </Link>{' '}
            and found it very simple to set up. If you are just testing the application or dipping
          ...
          <Typography variant="body1">
            ...
            <Link href="https://github.com/fiatjaf/nos2x">Nos2x</Link> and{' '}
            <Link href="https://github.com/getAlby/lightning-browser-extension">Alby</Link> have
            worked for us.
          </Typography>
          <Typography variant="body1">
